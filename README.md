...
| File | Descrizione |
|------|-------------|
| `landingpage.html` | Homepage con hero, sezione "Chi siamo" e footer |
| `servizi.html` | Pagina dei servizi offerti |
...
- **Accessibilità** — attributi ARIA, alt text descrittivi, link semantici
- **SEO base** — meta description e author su ogni pagina
